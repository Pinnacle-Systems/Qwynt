...
const stockApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getQrStockForPacking: builder.query({
      query: (params) => {
        return {
          url: STOCK_API + "/getQrStockForPacking",
          method: "GET",
          headers: {
            "Content-type": "application/json; charset=UTF-8",
          },
    ...
    getQrStockForReturn: builder.query({
      query: (params) => {
        return {
          url: STOCK_API + "/getQrStockForReturn",
          method: "GET",
          headers: {
            "Content-type": "application/json; charset=UTF-8",
          },
...
export const {
  ...
  useGetQrStockForPackingQuery,
  useLazyGetQrStockForPackingQuery,
  useLazyGetQrStockForReturnQuery,
} = stockApi;
