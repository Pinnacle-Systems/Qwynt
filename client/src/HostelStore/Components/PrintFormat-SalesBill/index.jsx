    ...
    <Document>
      <Page style={styles.page}>
        <View fixed style={styles.headerContainer}>
          ...
          <Text style={styles.title}>{isOn ? "INVOICE" : "QUOTATION"}</Text>
          ...
          <View style={styles.infoWrapper}>
            <View style={styles.fromInfoContainer}>
              ...
              <Text style={styles.infoText}>
                ...
                <Text style={styles.bold}></Text> FISH MERCHANT & ALL FISH
                COMMISSION AGENT
              </Text>
              <Text style={styles.infoText}>
                <Svg style={styles.icon} viewBox="0 0 24 24">
                ...
                <Text style={styles.bold}></Text> 29, KANGEYAM CROSS ROAD,
                TIRUPUR-4
              </Text>
              <Text style={styles.infoText}>
                <Svg style={styles.icon} viewBox="0 0 24 24">
                ...
                <Text style={styles.bold}></Text> 8220468448, 8300022602,
                9940806009, 6381644996
              </Text>
            </View>
          ...
          <View style={styles.tableContainer}>
            ...
            <View style={styles.amountInWordsContainer}>
              <Text style={styles.amountInWordsText}>
                ...
                Amount in Words:{" "}
                {totalAmount
                  ? numWords(parseInt(totalAmount)).toUpperCase()
                  : "Invalid amount"}{" "}
                RUPEES
              </Text>
            </View>
